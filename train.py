...
Examples:
  ...
  python train.py --preset baseline --test
    ...
    config_group.add_argument(
        '--preset',
        type=str,
        help='Use preset configuration (baseline, time_optimal, racing_line)'
    )
    config_group.add_argument(
        '--config',
        type=str,
    ...
    parser.add_argument(
        '--test',
        action='store_true',
        help='Run in test mode (shortened training for verification)'
    )
    parser.add_argument(
        '--verbose',
        action='store_true',
    ...
    parser.add_argument(
        '--list-experiments',
        action='store_true',
        help='List previous experiments and exit'
    )
